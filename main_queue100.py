"""Interface de fila para até 100 links; main_batch.py permanece intacto.
...
class App:
    def __init__(self, root):
        self.root = root
        self.running = False
        root.title("Converte MP3 Sem Limite Evaldo — até 100 links")
        ...
        label("Links do YouTube (um por linha; até 100, sem repetição):")
